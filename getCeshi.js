...
const funInfo = {
  funName: '/bybit.compliancewall.v1.ComplianceWallAPI/GetUserTypeList',
  reqPath: 'bybit.compliancewall.v1.GetUserTypeListRequest',
  resPath: 'bybit.compliancewall.v1.GetUserTypeListResponse',
  pbRootPath: './proto3'
};
